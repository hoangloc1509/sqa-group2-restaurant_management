...
<html>
  <head>
    ...
    <body class="manager-container">
      ...
      <main class="main">
        <h1 class="heading-main">Detailed receipt</h1>
        <form class="result" action="GetReceipt">
            <table class="table-result">
                <tr bgcolor="c5d9f1">
                    <th class="table-heading">No</th>
                    <th class="table-heading">Dish name</th>
                ...
                <% i++; %>  
                    <tr bgcolor="ffffff">
                        ...
                        <td class="table-body"><%=t.getName()%></td>
                        <td class="table-body"><%=t.getPrice()%></td>
                    </tr>
                <%}%>
                <tr>
                        <td class="table-total"></td>
                        <td class="table-total">Total amount:</td>
                        <td class="table-total"><%=request.getAttribute("receipt_amount")%></td>
                </tr>
            </table>
        </form>
      </main>
