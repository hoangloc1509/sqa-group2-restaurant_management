<%-- Document : Retry Created on : Mar 20, 2022, 4:49:34 PM Author : dotav --%>
...
<html>
  ...
  <body class="notification">
    ...
    <div class="notification-container">
      <ion-icon class="notification-unsuccess" name="sad-outline"></ion-icon>
      <h1 class="notification-heading">You haven't booked a table yet!</h1>
      <a class="btn btn-back" href="ClientHomepage.jsp">Back to homepage</a>
      <a class="btn btn-try" href="MakeReser.jsp"> Try again</a>
    </div>
